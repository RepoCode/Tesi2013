...
public class TestAudio extends FragmentActivity implements SurfaceHolder.Callback  {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    final ImageButton audio = (ImageButton) this.findViewById(R.id.button_play_audio);
	...
	private void sendAudioFrame() {
		  /* Set Frame di richiesta Audio  --> 3 */
		  String _frame= FunctionF454.getFrameWithIp(3);
	...
	// Chiamata dal codice nativo. Imposta lo stato della pipeline, visualizzato nella UI.
	    ...
	    public void startMainActivity(){
	    	finish();
			Intent i = new Intent(TestAudio.this, MainActivity.class);
			startActivity(i);
	    }
